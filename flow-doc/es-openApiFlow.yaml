  ...
  /invoice/getOverDue:
     get:
      ...
      parameters:
        ...
        - in: query
          name: filter
          description: Filtro por asunto del Invoice (Importe).
          required: false
          schema:
            type: string
        - in: query
      ...
      responses:
        '200':
          description: "Lista paginada de Invoices vencidos"
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/List'
  ...
  schemas:
        ...
        paymentData:
          ...
          properties:
            ...
            installments:
              type: number
              nullable: true
              description: Número de cuotas (si el pago fue con tarjeta de crédito).
              example: 3
            autorizationCode:
              type: string
              nullable: true
    ...
    Subscription:
      ...
      properties:
        ...
        discount_balance:
          type: string
          description: Monto de balance a favor en la suscripción
          example: '20000.0000'
        newPlanId:
          type: number
          description: Id del nuevo plan programado a cambiarse
          example: 12
        new_plan_scheduled_change_date:
          type: string
          description: Fecha de cambio de plan programado
          example: null
        in_new_plan_next_attempt_date:
          type: string
          description: Fecha de proximo intento de cambio de plan
          example: null
        morose:
          type: number
          description: | 
        ...
        planAdditionalList:
          type: array
          description: Lista de adicionales asociados a la suscripción.
          items:
            type: object
          example:
            - s_item_id: 3
    ...
    ItemAdditional:
      properties:
        id:
          type: number
          description: "El identificador del item adicional"
          example: 166
        name:
          type: string
          description: "El nombre del item adicional"
          example: 166
        amount:
          type: number
          description: "Monto del item adicional, si es negativo es un descuento, si es positivo un recargo"
        ...
        currency:
          type: string
          description: "La moneda del item adicional"
          example: CLP
        associatedSubscriptionsCount:
          type: number
          description: "Cantidad de suscripciones asociadas al item adicional"
          example: 1
        status:
          type: number
          description: "El estado del item adicional, Activo = 1, Inactivo = 0"
          example: 1
        created:
          type: string
          description: "La fecha de creación del item adicional"
          example: "2018-07-13 09:57:53"
    ...
    SubscriptionChangePlanResponse:
      type: object
      description: Objeto de respuesta al cambiar plan de suscripción
      properties:
        start_date_of_new_plan:
          type: string
          description: Fecha de inicio del nuevo plan
          example: "2024-10-13"
        new_amount:
          type: string
          description: Monto del nuevo plan
          example: "5000"
        new_currency:
          type: string
          description: Moneda del nuevo plan
          example: "CLP"
        new_plan_id:
          type: string
          description: ID del nuevo plan
          example: "plan superior"
        balance:
          type: number
          description: Saldo prorrateado (si es negativo es un descuento, si es positivo es un cargo que se cobrará al momento de cambiar el plan)
          example: -5000
        old_amount:
          type: string
          description: Monto del plan anterior
          example: "10000"
        old_currency:
          type: string
          description: Moneda del plan anterior
          example: "CLP"
        old_plan_id:
          type: string
          description: ID del plan anterior
          example: "plan inferior"
    SubscriptionChangePlanCancelResponse:
      type: object
      description: Objeto de respuesta al cancelar el cambio de plan de suscripción
      properties:
        success:
          type: boolean
    ...
    SubscriptionItemChangeResponse:
      type: object
      description: Objeto de respuesta al agregar o editar un item en una suscripción
      properties:
        sub_id:
          type: string
          description: Identificador de la suscripción
          example: "sub_azcyjj9ycd"
        item_id:
          type: number
        ...
        success:
          ...
          description: Indica si la operación fue exitosa
          example: true
    SubscriptionChangePlanPreviewResponse:
      type: object
      description: Objeto de respuesta al previsualizar el cambio de plan de suscripción
      properties:
        balance:
          type: object
          description: Información del balance a cobrar o a favor relacionado al cambio de plan
          properties:
            amount:
              type: integer
              description: Saldo prorrateado (si es negativo es un descuento, si es positivo es un cargo).
              example: -5000
            credit_expiration_date:
              type: string
              description: Fecha limite donde se aplicará descuento por balance a favor, si el valor es null se aplicará de manera indefinida en caso de tener balance a favor.
              example: "21-11-2024"
              nullable: true
            credit_expiration_amount:
              type: integer
              description: Balance a favor que quedará sin utilizarse. Si el valor es null, se intentará utilizar todo el balance a favor disponible.
              example: 2000
              nullable: true
            credit_expiration_warning:
              type: string
              description: Mensaje de advertencia en caso de que el balance a favor no sea utilizado por los periodos definidos. Si el valor es null, indica que no hay mensaje de advertencia.
              example: "The remaining credit will not be fully used in the remaining billing periods."
              nullable: true
        balance2:
          type: number
          description: Saldo prorrateado (si es negativo es un descuento, si es positivo es un cargo)
        ...
        next_invoice_date:
          type: string
          description: Fecha de la próxima factura (invoice)
          example: "11-11-2024"
        old_plan:
          type: object
          description: Información del plan anterior
          properties:
            name:
              type: string
              description: Nombre del plan anterior
              example: "plan inferior 3"
            currency:
              type: string
              description: Moneda del plan anterior
              example: "CLP"
            ...
            periods_number:
              type: integer
              description: Número de periodos del plan anterior
              nullable: true
              example: null
        new_plan:
          type: object
          ...
          properties:
            name:
              type: string
              description: Nombre del nuevo plan
              example: "plan inferior 4"
            currency:
              type: string
              description: Moneda del nuevo plan
              example: "CLP"
            ...
            periods_number:
              type: integer
              description: Número de periodos del nuevo plan
              nullable: true
              example: null
# componentes que se usan en la documention con redocusaurus
    MerchantCreate:
      type: object
      properties:
        apiKey:
    ...
    RequestPaymentStatus:
      type: object
      description: Objeto de estado de una orden
      properties:
          apiKey: 
            description: apiKey del comercio
            type: string
            example: "1F90971E-8276-4715-97FF-2BLG5030EE3B"
          token:
            description: token de la transacción enviado por Flow
            type: string
            example: "AJ089FF5467367"
          s:
            description: la firma de los parámetros efectuada con su secretKey
            type: string
            example: "33373581FC32576FAF33C46FC6454B1FFEBD7E1H"
    ...
    ConfirmationRequest:
      ...
      properties:
        token:
          type: string
          description: Token de transacción
          example: 123187565538192
    RefundCreateRequest:
      type: object
      description: Body del llamado de reembolso
      properties:
        apiKey:
          description: apiKey del comercio
          type: string
          example: 735646182987483
        refundCommerceOrder:
          description: La orden de reembolso del comercio
          type: string
          example: uuid-1230-3123-1231
        receiverEmail:
          description: Email del receptor del reembolso
          type: string
        amount:
