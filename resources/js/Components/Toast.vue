...
<template>
    <div 
        class="flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800 border-l-4 transition-all transform duration-300 ease-in-out hover:scale-105"
        :class="{
            'border-green-500': type === 'success',
            'border-red-500': type === 'error',
            'border-blue-500': type === 'info' || type === 'message',
        }"
        role="alert"
    >
        <!-- Icons -->
        ...
        <div v-else class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-blue-500 bg-blue-100 rounded-lg dark:bg-blue-800 dark:text-blue-200">
