...
const navItems = [
    ...
    { name: 'Promotions', route: 'admin.promotions.index', icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z' },
    { name: 'Notifications', route: 'admin.notifications.create', icon: 'M15 17h5l-1.405-1.405C18.21 15.21 18 14.705 18 14V9a6 6 0 10-12 0v5c0 .705-.21 1.21-.595 1.595L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
];
